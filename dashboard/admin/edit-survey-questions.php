...
$pdoQuery = "SELECT * FROM question WHERE Id=$questionsID";
$pdoResult = $pdoConnect->prepare($pdoQuery);
$pdoExec = $pdoResult->execute();
$questions_data = $pdoResult->fetch(PDO::FETCH_ASSOC);

$questions_title = $questions_data['questions'];
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<ul class="breadcrumbs">
						...
						<p class="divider">|</p>
						<p><a href="" class="active">Edit Questions</a></p>
					</ul>

                    <section class="data-form">
                        <div class="header"></div>
                        <div class="registration">
                            <form action="controller/edit-question-controller.php?questionsID=<?php echo $questionsID ?>&surveyID=<?php echo $surveyID ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">

                                    <div class="col-md-12">
                                        <label for="questions" class="form-label">Questions<span> *</span></label>
                                        <textarea class="form-control" placeholder="Add questions" value="<?php echo $questions_title ?>" id="floatingTextarea2" style="height: 200px" name="questions" id="questions" required><?php echo $questions_title ?></textarea>
                                        <div class="invalid-feedback">
                                            Please provide a Questions.
                                        </div>
                                    </div>
                                ...
                                <div class="addBtn">
                                    <button type="submit" class="primary" name="btn-edit-questions" id="btn-edit-questions" onclick="return IsEmpty(); sexEmpty();">Update</button>
                                </div>
                            </form>
                        </div>
                    </section> <br>
