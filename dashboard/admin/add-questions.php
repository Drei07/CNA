            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<ul class="breadcrumbs">
						...
						<p class="divider">|</p>
                        <p><a href="view-survey?Id=<?php echo $_GET['Id'] ?>">Survey Data</a></p>
                        <p class="divider">|</p>
						<p><a href="" class="active">Add Questions</a></p>
					</ul>
                    ...
                    <section class="data-form">
                        ...
                        <div class="registration">
                            <form action="controller/add-question-controller.php?Id=<?php echo $surveyID ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">

                                    <div class="col-md-12">
                                        <label for="questions" class="form-label">Questions<span> *</span></label>
                                        <textarea class="form-control" placeholder="Add questions" id="floatingTextarea2" style="height: 200px" name="questions" id="questions" required></textarea>
