            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<ul class="breadcrumbs">
						...
						<p class="divider">|</p>
                        <p><a href="survey-data">Survey Data</a></p>
						<p class="divider">|</p>
						<p><a href="" class="active">Edit Survey</a></p>
					</ul>
                    ...
                    <section class="data-form">
                        ...
                        <div class="registration">
                            <form action="controller/edit-survey-controller.php?Id=<?php echo $surveyID?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">

                                    <div class="col-md-12">
                                        <label for="title" class="form-label">Title<span> *</span></label>
                                        <input type="text"  class="form-control" value="<?php echo $title ?>" autocapitalize="on"  autocomplete="off" name="title" id="title"  required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" value="<?php echo $start_date ?>" autocapitalize="on"  autocomplete="off" name="start_date" id="start_date" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" value="<?php echo $end_date ?>" autocapitalize="on"  autocomplete="off" name="end_date" id="end_date"  required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea type='text' class="form-control" placeholder="Add description" value="<?php echo $description ?>" id="floatingTextarea2" style="height: 200px" name="description" id="description" required><?php echo $description ?></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="addBtn">
                                    <button type="submit" class="primary" name="btn-edit-survey" id="btn-edit-survey" onclick="return IsEmpty(); sexEmpty();">Update</button>
                                </div>
                            </form>
                        </div>
                    </section> <br>
