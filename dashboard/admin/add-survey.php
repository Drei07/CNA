            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<ul class="breadcrumbs">
						...
						<p class="divider">|</p>
						<p><a href="" class="active">Add Survey</a></p>
					</ul>
                    ...
                    <section class="data-form">
                        ...
                        <div class="registration">
                            <form action="controller/add-survey-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                <div class="row gx-5 needs-validation">

                                    <div class="col-md-12">
                                        <label for="title" class="form-label">Title<span> *</span></label>
                                        <input type="text"  class="form-control" autocapitalize="on"  autocomplete="off" name="title" id="title"  required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" autocapitalize="on"  autocomplete="off" name="start_date" id="start_date" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" autocapitalize="on"  autocomplete="off" name="end_date" id="end_date"  required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" placeholder="Add description" id="floatingTextarea2" style="height: 200px" name="description" id="description" required></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="addBtn">
                                    <button type="submit" class="primary" name="btn-add" id="btn-add" onclick="return IsEmpty(); sexEmpty();">Add</button>
                                </div>
                            </form>
                        </div>
                    </section> <br>
