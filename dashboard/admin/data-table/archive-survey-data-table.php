<table class="table table-bordered table-hover">
  ...
  $query = "
SELECT * FROM survey WHERE admin_id = :admin_id AND status = :status
";
  $output = '';
  if ($_POST['query'] != '') {
    $query .= '
...
';
    ...
    <tr>
      ...
      <td><button type="button" class="V"> <a href="controller/restore-survey?Id='.$row["Id"].'" class="restore">Restore</a></button></td>
    </tr>
    ';
    }
  } else {
...
';
  ...
  <script>
    ...
    $('.restore').on('click', function(e) {
      ...
      swal({
          title: "Restore?",
          text: "Do you want to restore this survey?",
          icon: "info",
          buttons: true,
          dangerMode: true,
        })
