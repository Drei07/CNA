...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="../../dashboard/user/authentication/user-forgot-password.php" method="POST" novalidate="" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
					...
					<div class="flex-col-c p-t-170 p-b-40">
						...
						<a href="create-account" class="txt3">
							Sign up now
						</a>
					</div>
				</form>
