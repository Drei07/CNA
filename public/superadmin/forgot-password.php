...
<body>
	<div class="container-login100">
		<div class="wrap-login100">
			<form action="../../dashboard/superadmin/authentication/superadmin-forgot-passwor" method="POST" novalidate="" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
