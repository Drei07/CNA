...
<head>
    ...
    <title>CNA | Superadmin | Forgot Password?</title>
...
<body>
    <div class="session">
        ...
        <form action="../../dashboard/superadmin/authentication/superadmin-forgot-password.php" method="POST" class="log-in" autocomplete="off">
